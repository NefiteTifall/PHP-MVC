...
?>
    ...
    <section id="advantages">
        ...
        <span class="rond rond-fonce" id="rondAdvantage1"></span>
        <span class="rond rond-fonce" id="rondAdvantage2"></span>
        <span class="square square-fonce" id="squareAdvantage1"></span>
        <span class="square square-fonce" id="squareAdvantage2"></span>
        <span class="rond-inv" id="rondInvAdvantage1"></span>
