...
<header>
    <nav class="navbar navbar-expand-md">
        <div class="containerLogo">
            <a class="navbar-brand d-flex" href="/">
                ...
                <img class="logo" id="HeaderLogo_light" src="/resources/image/HeaderLogo_light.png"
                     alt="Logo de Foxwind">
                <h1>FoxWind</h1>
            </a>
        </div>
        <button class="navbar-toggler custom-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbar" aria-controls="navbar" aria-expanded="false"
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item clickable">
                    <a class="nav-link" href="/cart">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="44" viewBox="0 0 151.731 140.072">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/compte">
                        <button class="full-button-white">Compte</button>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="HeaderWave">
        <svg class="waves" viewBox="0 24 150 28" preserveAspectRatio="none">
            ...
            <g class="wavesEffect">
                <use href="#wave" x="48" y="0" fill="rgba(124,142,65,0.7"/>
                <use href="#wave" x="48" y="3" fill="rgba(124,142,65,0.5)"/>
                <use href="#wave" x="48" y="5" fill="rgba(124,142,65,0.3)"/>
                <use href="#wave" x="48" y="7" fill="rgba(124,142,65,1)"/>
            </g>
        </svg>
    </div>
</header>
