<div class="toast__container">
    <div class="toast__cell">
        <?php if ($_SESSION["popup"]["type"] === "success") { ?>
            <div class="toast toast--green showing">
                ...
                <div class="toast__content">
                    <p class="toast__type"><?php echo $_SESSION["popup"]["title"] ?></p>
                    <p class="toast__message"><?php echo $_SESSION["popup"]["text"] ?></p>
                </div>
        ...
        <?php } else if ($_SESSION["popup"]["type"] === "info") { ?>
            <div class="toast toast--blue add-margin showing">
                <div class="toast__icon">
                    <svg version="1.1" class="toast__svg" xmlns="http://www.w3.org/2000/svg"
        ...
        <?php } else if ($_SESSION["popup"]["type"] === "error") { ?>
            <div class="toast toast--yellow add-margin showing">
                <div class="toast__icon">
