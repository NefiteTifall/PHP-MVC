...
//Fonction qui debloque les informations du compte
function unlockUserInfos(){
  const inputs = document.getElementsByClassName("form-control");
  //Boucle des elements trouvés a partir de la class "form-control"
  for(let i=0; i<inputs.length; i++){
    let item = $(inputs[i]);
    if(item.attr("disabled").includes("")){
